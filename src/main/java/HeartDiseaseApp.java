...
import java.io.File;
public class HeartDiseaseApp {
    public static void main(String[] args) throws Exception {
        double learninRate=0.001;
        int batchSize=1;
        int inputSize=13; int outputSize=2;
        int classIndex=13;
        int numHidden=15;
        ...
        File fileTrain=new ClassPathResource("heartTrain.csv").getFile();
        ...
        File fileTest=new ClassPathResource("heartTest.csv").getFile();
        ...
        ModelSerializer.writeModel(model,"HeartDiseaseModel.zip",true);
